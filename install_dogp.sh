...
echo ""
echo -e "${YELLOW}Write Node that want to create MENU or press enter to exit : ${NC}"
read MENU1
	if [[ $MENU1 = "" ]] ;
	then
c=1
...
echo -e "${YELLOW}Write Node that want to UPGRADE/REPAIR or press enter to exit : ${NC}"
read DEL2
if [[ $DEL2 = "" ]]
then
c=1
