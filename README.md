...
<li>
				...
				<ol type="a">
					<li>Choose option 1 for create new masternode, and follow the instruction. <br></li>
					<li>Do you want to install all needed dependencies? choose y for new vps<br/></li>
