...
<h3><ol>
				...
				<ol type="a">
				<li>
				<span style="background-color:#ccc; font-weight:bold; font-size:18px; padding:10px 20px 10px 20px"><quote>wget https://raw.githubusercontent.com/cryptosam212/DogePrivate-DGP/master/install_dogp.sh && bash install_dogp.sh </quote></span><br>
				<br>
